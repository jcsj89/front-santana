            ...
            <div className="flex flex-col justify-center items-center lg:w-2/3 ">
                <div className="flex flex-col justify-center items-center p-3 sm:p-5 lg:p-14 ">
                    ...
                    >
                        em limpeza{" "}
                        <span
                            className={`${truculenta.className} text-gray-200 text-xl`}
                        >
                            automotiva
                        </span>
                    </h2>
                    ...
                    <div className="flex flex-col items-center justify-between w-3/4  relative">
                        <p className="lg:w-3/4 text-justify">
                            Nossos produtos são a chave para um resultado
                            profissional incomparável. Deixe seu veículo
                            impecável, com brilho e proteção de longa duração.
                            Descubra o segredo por trás de cada lavagem de
                            sucesso e experimente agora.
                        </p>
                    </div>

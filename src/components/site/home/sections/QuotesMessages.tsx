...
const QuotesMessages = () => {
    ...
    const [quoteOfWeek, setQuoteOfWeek] = useState<IQuote>();
    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center w-full">
                <h5
                    className={`${delius.className} text-4xl w-2/3 lg:w-1/3 `}
                >
                    {quoteOfWeek?.message}
                </h5>
                ...
                <h6
                    className={`${montserrat.className}  w-2/3 lg:w-1/3 text-lg`}
                >
                    {day} - {month} - {year}
                </h6>
            </div>

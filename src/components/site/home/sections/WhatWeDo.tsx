            ...
            >
                ...
                >
                    ...
                    <li className="flex items-center justify-center p-2">
                        ...
                        <span className="ml-3">
                            Lavagem profissional de automoveis
                        </span>
                    </li>
                    <li className="flex items-center justify-center p-2">
                ...
                <p className="antialiased my-10 text-gray-200">
                    Na Santana Química, somos especializados na fabricação de
                    produtos de limpeza automotiva de alta qualidade. Nossa
                    linha abrange soluções inovadoras e eficientes para a
                    limpeza, proteção e manutenção de veículos, oferecendo
                    produtos que garantem brilho, durabilidade e proteção das
                    superfícies. Trabalhamos com tecnologia avançada para
                    desenvolver shampoos, desincrustantes, desengraxantes, e
                    outros itens essenciais para o cuidado do seu automóvel.
                    Nosso compromisso é entregar produtos que facilitem o
                    trabalho de quem cuida de veículos, assegurando eficiência e
                ...
                <div className="flex justify-center w-full">
                    <LinkPage
                        href="/produtos"
                        className="border-b border-blue-200 text-yellow-300 hover:text-yellow-400 mb-10"
                    >
